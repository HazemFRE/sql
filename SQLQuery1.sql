...
Select AVG (Cast (PublishedYear As Float ) ) As AveragePublicationYear FROM Books;
 ...
 Add Email  varchar (100) ,
  ...
  UPDATE Authors
SET Email = 'Ralph@gmail.com', PhoneNumber = '+54655447'
WHERE AuthorID = 1;

UPDATE Authors
SET Email = 'James@gmail.com', PhoneNumber = '+86456455'
WHERE AuthorID = 2;

UPDATE Authors
SET Email = 'James@gmail.com', PhoneNumber = '+99654599'
WHERE AuthorID = 3;

UPDATE Authors
SET Email = 'Frank@gmail.com', PhoneNumber = '+66654516'
WHERE AuthorID = 4;
